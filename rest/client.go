...
func ( c *Client ) postJson( ctx context.Context, methodName string, object interface{} ) ( responseBody []byte, err error ) {
...
func ( c *Client ) Connect( ctx context.Context, key wgtypes.Key ) ( connectResponse *ConnectResponse, err error ) {
	...
	responseBody, err := c.postJson( ctx, "connect", connectRequest )
	if err != nil { return }
...
func ( c *Client ) Disconnect( sessionToken []byte ) ( err error ) {
	...
	_, err = c.postJson( context.Background(), "disconnect", disconnectRequest )
	return
}
...
func ( c *Client ) GetAccessToken( ctx context.Context ) ( err error ) {
	...
	accessTokenJson, err := c.postJson( ctx, "accessToken", accessTokenRequest )
	if err != nil { return }
